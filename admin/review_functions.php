              ...
              <div class="row">
                ...
                <div class="col-12 col-md-8 col-lg-8 order-3 order-md-2">
                  <div class="row">
                    ...
                    <div class="card">    
                <h5 class="card-header">List of Functions</h5>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0" id="function_data">
