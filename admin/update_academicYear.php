                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <?php 
$select="SELECT * FROM academic_year where ac_id='".$_GET['ac_id']."'";
...
$row_cselect=$cselect->fetch(PDO::FETCH_ASSOC);
                       ...
                       ?>
                      <form method="post" id="academic_update">
                        <div class="mb-3">
                          <label class="form-label">Academic Year Name</label>
                          <input type="text" class="form-control" name="ac_name"  placeholder="Academic Year Name" value="<?php echo $row_cselect['ac_name']; ?>">
                        </div>
                        <input type="hidden" name="ac_id" value="<?php echo $row_cselect['ac_id']; ?>">                    
                        <button type="submit" class="btn btn-primary" id="update_academics">Update Academic Year</button>
                      </form>
                    </div>
                  </div>
                </div>
        ...
        $(document).ready(function () {
          ...
          $("#academic_update").validate({
            ...
            unhighlight: function (element, errorClass, validClass) {
             ...
             var f = $("#academic_update")[0];
              var form = new FormData(f);
              $.ajax({
                url: '../php/update_academic.php',
                type: 'POST',
                data: form,
                cache: false,
                processData: false,
                contentType: false,
                beforeSend: function () {
                    $('#update_academics').html('Progress <i class="fa fa-solid fa-spinner fa-spin"></i>');
                    $('#update_academics').attr("disabled", true);
                ...
                // }
                 ...
                 complete: function () {
                    setTimeout(function () {
                        ...
                        $('#update_academics').html('Update Academic Year');
                        $('#update_academics').attr("disabled", false);
                    }, 200);
                },
