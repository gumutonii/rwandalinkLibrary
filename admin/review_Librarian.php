              ...
              <div class="row">
                ...
                <div class="col-12 col-md-8 col-lg-12 order-3 order-md-2">
                  <div class="row">
                    ...
                    <div class="card">    
                <h5 class="card-header">Librarian List</h5>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0" id="librarian_data">
    ...
    $.ajax({ 
           url:"librarian_data.php",
            ...
            success: function(data) {
                $('#librarian_data').html(data);
            },
     });
};
     
     function delete_librarian(data){
        $.ajax({
                url: '../php/delete_librarian.php',
                type: 'POST',
                data: {
                  data:data
                },
