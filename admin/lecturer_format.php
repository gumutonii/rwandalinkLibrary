                ...
                <div class="col-12 col-md-8 col-lg-12 order-3 order-md-2">
                  ...
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Class Registration Form/ <span><a href="lecturer.php" class="btn btn-info">Register single Lecturer</a></span></h5>
                      
                    </div>
                    <div class="card-body">
                      <div class="alert alert-danger alert-dismissible" id="error-display" style="display:none;"></div>
                      <form method="POST" id="lecturer_form">
                        
                        
                        <div class="row mb-3">
                          <label class="col-sm-2 form-label" for="basic-icon-default-phone">Department</label>
                          <div class="col-sm-10">
                        ...
                        <div class="row mb-3" >
                          ...
                          <div class="col-sm-10" id="optionss">
                            <div class="input-group input-group-merge">
                              ...
                              ></span>
                              <select class="form-select form-select-lg" name="l_status">
...
while($row_cselect_status=$cselect_status->fetch(PDO::FETCH_ASSOC)){
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
    <button type="submit" class="btn btn-primary" id="view_lecturer_formart">view Format</button>
                          </div>
                        </div>
...
fetch();
          ...
          $("#lecturer_form").validate({
            ...
            unhighlight: function (element, errorClass, validClass) {
             ...
             var f = $("#lecturer_form")[0];
              var form = new FormData(f);
              $.ajax({
                url: 'whole_lecturer_format.php',
                type: 'POST',
                data: form,
                cache: false,
                processData: false,
                contentType: false,
                beforeSend: function () {
                    $('#view_lecturer_formart').html('Progress  <i class="fa fa-solid fa-spinner fa-spin"></i>');
                    $('#view_lecturer_formart').attr("disabled", true);
                },
              ...
              window.location.href=dataResult;
                 ...
                 complete: function () {
                    setTimeout(function () {
                        ...
                        $('#view_lecturer_formart').html('View');
                        $('#view_lecturer_formart').attr("disabled", false);
                    }, 200);
                },
