...
$d_id=$_GET['d_id']; 
$o_id=$_GET['o_id'];
$select_department="SELECT * FROM department WHERE d_id='$d_id'";
...
$select_option="SELECT * FROM options WHERE o_id='$o_id' AND d_id='$d_id'";
...
$row_cselect_option=$cselect_option->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
                <h5 class="card-header">List Of Student in <?php echo $row_cselect_department['d_shortname'] ; ?>/<?php echo $row_cselect_option['o_shortname']; ?></h5>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0" id="department_student_data">
    ...
    $.ajax({ 
           url:"students_data.php",
            ...
            success: function(data) {
                $('#department_student_data').html(data);
            },
     });
};
