          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                ...
                <div class="table-responsive text-nowrap" id="bookType_data">
    ...
    $.ajax({ 
           url:"bookTypes_data.php",
            ...
            success: function(data) {
                $('#bookType_data').html(data);
            },
     });
};

function delete_bookTypes(data){
        $.ajax({
                url: '../php/delete_bookTypes.php',
                type: 'POST',
                data: {
                  data:data
                },
              ...
              beforeSend:function(){
                ...
                return confirm('Are You Sure You Want To Delete This Book Type');
              },
