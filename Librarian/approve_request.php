              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <h5 class="card-header">Book Acceptence form</h5>
                    <!-- Account -->
                      ...
                      <form id="accept_form" method="POST" >
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <?php 
$select_book="SELECT * FROM student_request WHERE sr_id='".$_GET['sr_id']."'";
$cselect_book=$connect->prepare($select_book);
$cselect_book->execute();
$row_cselect_book=$cselect_book->fetch(PDO::FETCH_ASSOC);

$book="SELECT * FROM books where b_SN='".$row_cselect_book['b_SN']."'";
$cbook=$connect->prepare($book);
$cbook->execute();
$row_cbook=$cbook->fetch(PDO::FETCH_ASSOC);



                             ?>
                            <input class="form-control" type="text" name="b_Author" value="<?php echo $row_cbook['b_Author'] ?>" readonly>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="b_title" class="form-label">Book title</label>
                            <input class="form-control" type="text" name="b_title" value="<?php echo $row_cbook['b_title'] ?>" readonly>
                          </div>
                          <div class="mb-3 col-md-6">
...
$select_reg="SELECT * FROM student WHERE s_id='".$row_cselect_book['s_id']."'";
$cselect_reg=$connect->prepare($select_reg);
$cselect_reg->execute();
 ...
 ?>
                            ...
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                name="b_Publisher"
                                class="form-control"
                                value="<?php echo $row_cselect_reg['s_regno'] ?>"
                                readonly
                              />
                            </div>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">Student Phone N<sup>o</sup></label>
<?php 
$select_book="SELECT * FROM student_request WHERE sr_id='".$_GET['sr_id']."'";
$cselect_book=$connect->prepare($select_book);
$cselect_book->execute();
 ...
 ?>
                            ...
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                name="b_Publisher"
                                class="form-control"
                                value="<?php echo $row_cselect_reg['s_phone'] ?>"
                                readonly
                              />
                            </div>
                          </div>
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" id="accept_offer">Accept Offer</button>
                        </div>
                      </form>
                    </div>
                    <!-- /Account -->
          ...
          $("#accept_form").validate({
            ...
            unhighlight: function (element, errorClass, validClass) {
             ...
             var f = $("#accept_form")[0];
              ...
              $.ajax({
                url: '../php/librarian_accept_request.php',
                type: 'POST',
                data: form,
                cache: false,
                processData: false,
                contentType: false,
                beforeSend: function () {
                    $('#accept_offer').html('Progress <i class="fa fa-solid fa-spinner fa-spin"></i>');
                    $('#accept_offer').attr("disabled", true);
                ...
                // }
                 ...
                 complete: function () {
                    setTimeout(function () {
                        ...
                        $('#accept_offer').html('Accept Offer');
                        $('#accept_offer').attr("disabled", false);
                    }, 200);
                },
