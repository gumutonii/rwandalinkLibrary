                ...
                <div class="col-12 col-md-8 col-lg-12 order-3 order-md-2">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <form method="POST" id="books_details">
                        <div class="row">
...
while($row_cselect_department=$cselect_department->fetch(PDO::FETCH_ASSOC)){
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-12">
                            <button type="submit" class="btn btn-primary" id="dep_book">View Books</button>
                          </div>
                        </div>
        ...
        $(document).ready(function () {
          ...
          $("#books_details").validate({
            ...
            unhighlight: function (element, errorClass, validClass) {
             ...
             var f = $("#books_details")[0];
              var form = new FormData(f);
              $.ajax({
                url: 'books_information.php',
                type: 'POST',
                data: form,
                cache: false,
                processData: false,
                contentType: false,
                beforeSend: function () {
                    $('#dep_book').html('Progress  <i class="fa fa-solid fa-spinner fa-spin"></i>');
                    $('#dep_book').attr("disabled", true);
                },
              ...
              window.location.href=dataResult;
                 ...
                 complete: function () {
                    setTimeout(function () {
                        ...
                        $('#dep_book').html('view Books');
                        $('#dep_book').attr("disabled", false);
                    }, 200);
                },
