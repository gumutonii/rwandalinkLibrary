              ...
              <div class="row">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0" id="lecturer_department_data">
    ...
    $.ajax({ 
           url:"lecturer_data.php",
            ...
            success: function(data) {
                $('#lecturer_department_data').html(data);
            },
     });
};
     
     function lecturer_delete(data){
        $.ajax({
                url: '../php/delete_lecturer.php',
                type: 'POST',
                data: {
                  data:data
                },
              ...
              beforeSend:function(){
                ...
                return confirm('Are You Want To Delete This Lecturer');
              },
